...
from app.services.source_qa_indexer import SourceQAIndexer, source_qa_enabled
from app.services.source_qa_enhancement import (
    SourceQAEnhancementService,
    SourceQAEnhancementTaskManager,
)
...
class SourceIngestionService:
    def __init__(
        ...
        *,
        ...
        qa_enhancement_service: SourceQAEnhancementService | None = None,
        qa_enhancement_task_manager: SourceQAEnhancementTaskManager | None = None,
    ) -> None:
        ...
        self.qa_enhancement_service = qa_enhancement_service or SourceQAEnhancementService(
            evidence_store=store,
            index_store=self.qa_index_store,
        )
        self.qa_enhancement_task_manager = (
            qa_enhancement_task_manager
            or SourceQAEnhancementTaskManager(service=self.qa_enhancement_service)
        )
        self.qa_indexer = qa_indexer or SourceQAIndexer(
            evidence_store=store,
            index_store=self.qa_index_store,
            enhancement_service=self.qa_enhancement_service,
        )
    ...
    def _remove_source_unlocked(self, record: SourceIngestionRecord) -> SourceIngestionRecord | None:
        ...
        self.qa_enhancement_service.store.delete_for_source(record=record)
    ...
    def _save_and_index_unlocked(
        ...
        *,
        ...
        if final_status == "ready" and source_qa_enabled():
            local_path = source_local_path(saved)
            if local_path is None:
        ...
        if final_status == "ready":
            self.qa_enhancement_task_manager.submit(final_record)
